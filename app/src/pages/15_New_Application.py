...
st.title("Submit a Venue Application")
st.write("Apply to list a new venue on PinDate. Our admin team will review and approve your submission.")
...
if submitted:
    if not name.strip() or not address.strip():
        ...
        st.warning("Max price must be greater than or equal to min price.")
    else:
